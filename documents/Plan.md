...
**Ожидаемый результат:**
появляется уведомление "Успешно." Выполняется запись в БД статус "APPROVED". Оплата проходит.
...
**Ожидаемый результат:**
появляется уведомление "Ошибка". Выполняется запись в БД статус "DECLINED". Оплата не проходит.
...
**Ожидаемый результат:**
под полем "Месяц" появляется уведомление "Неверно указан срок действия карты". Форма не отправляется.
...
**Ожидаемый результат:**
под полем "Год" появляется уведомление "Истек срок действия карты". Форма не отправляется.
...
**Ожидаемый результат:**
под полем "Владелец" появляется уведомление "Поле обязательно для заполнения". Форма не отправляется.
